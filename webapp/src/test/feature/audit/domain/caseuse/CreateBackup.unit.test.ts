...
describe('CreateBackup', () => {
    it('recorta la etiqueta y delega', async () => {
        const meta = { cid: 'c1', label: 'Salva', rev: 1, userId: 'u1', username: 'admin', createdAt: '2026-09-21' };
        const repo = mockOf<AuditRepository>({ createBackup: vi.fn().mockResolvedValue(meta) });
